...
nuitka --standalone --jobs=10 --windows-console-mode=attach --product-version=$version --file-description="A Scenario Editor for MySekaiStoryteller" --windows-icon-from-ico=app/resources/icons/logo.ico --include-data-dir=resources=resources --enable-plugins=pyside6,tk-inter,matplotlib --show-progress main.py
